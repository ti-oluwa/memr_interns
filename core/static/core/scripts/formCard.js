...
function checkInputFields(form) {
    const formInputFields = Array.from(form.querySelectorAll('.form-input'));
...
formCards.forEach(formCard => {
    ...
    const formInputs = formCardForm.querySelectorAll('.form-input');
    ...
    formInputs.forEach(input => {
        if (input.required) {
            ...
            formField.classList.add('required-field');
        }
    });
