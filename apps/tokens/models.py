...
from helpers.django.utils.requests import get_ip_address
...
class TimeBasedOTP(models.Model):
    ...
    key = models.CharField(
        max_length=50, default=random_hex, unique=True, db_index=True
    )
    ...
    def is_valid(self) -> bool:
        ...
        totp = self.totp()
        return totp.t() > self.last_verified_counter and totp.verify(self.token())
